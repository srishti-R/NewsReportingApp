package com.android.example.newsreportingapp.ReminderUtils;

import android.content.Context;
import android.support.annotation.NonNull;

import com.android.example.newsreportingapp.syncUtils.NewsDispatcher;
...
public class SettingPeriodicSync {
    ...
    synchronized public static void scheduleReminder(@NonNull final Context context) {
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setService(NewsDispatcher.class)
                /*
